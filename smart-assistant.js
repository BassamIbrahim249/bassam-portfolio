// =============== المساعد الهجين - BassamIbrahim (v14.5 – تدشين) ===============
(function () {
  'use strict';
  ...
  // ========== الردود الثابتة (الذخيرة اللغوية الشاملة) ==========
  ...
  // ردود متدرجة (عشوائية) للتحية والشكر والوداع
  ...
  const STATIC_REPLIES = {
    greeting: {
      keywords: [
        ...
        'كيف حالك','شلونك','ازيك','كيفك','هاي','hi','hello',
        'تمام','ماشي','يلا','حبيبي','يا صديقي','باشمهندس',
        'اخبارك','كيف اخبارك','الاخبار','الاخبار والامور','كيف الامور',
        'صباحو','مساءو','وينك','شمالك','يا هلا والله','نورت','نورتنا',
        'كيفك اليوم','كيف اخبارك اليوم','وين كنت','زمان ما شفتك'
      ],
      answer: null
    },
    farewell: {
      keywords: [
        ...
        'في امان الله','الله معاك','بروح','ماشي بروح','شكرا وبس','خلاص',
        'تصبح على خير'
      ],
      answer: null
    },
    assistant_identity: {
      keywords: [
        'من انت','انت منو','عرفني عليك','ممكن نتعرف','من انت بالضبط','انت بوت ولا انسان',
        'هل انت ذكاء اصطناعي','من صنعك','من برمجك','كيف تعمل','شو اسمك','ما اسمك'
      ],
      answer: '🤖 <b>أنا مساعد BassamIbrahim الذكي!</b><br><br>أنا بوت (ذكاء اصطناعي) متخصص في البحث داخل محتوى المنصة.<br>أقدر أبحث في <b>50+ مقالة</b> عبر 5 أقسام، وأجيب على أسئلتك، وألخص المقالات، وحتى أوصلك بالمهندس <b>بسام</b> مباشرة.<br><br>💡 جرب تسألني عن أي موضوع!'
    },
    about_bassam: {
      keywords: [
        'من هو بسام','بسام ابراهيم','صاحب الموقع','مطور الموقع',
        'نبذه عنك','عن بسام','من يكون','عرف بنفسك','عرف نفسك',
        'من هو مؤسس المنصه','منو اسس المنصه','مؤسس الموقع','من انشا المنصه'
      ],
    ...
    about_platform: {
      keywords: [
        ...
        'ما الهدف من تاسيس المنصه','لماذا تم تاسيس المنصه','ليه اسست المنصه',
        'سبب انشاء المنصه','من اجل ماذا انشئت المنصه'
      ],
      answer: '🌐 <b>منصة BassamIbrahim الرقمية</b> — منصة سودانية مستقلة غير ربحية، تهدف إلى نشر العلم والمعرفة في خمسة مجالات رئيسية:<br><br>🏗️ <b>المنصة الهندسية</b> — علوم المواد، ابتكار إنشائي، مختبر هندسي<br>🏛️ <b>الأرشيف السياسي</b> — تاريخ السودان، تحليل استراتيجي<br>🏺 <b>نوبيان</b> — الحضارة النوبية، التاريخ، الآثار<br>📚 <b>الأكاديمية</b> — المشاريع، القيادة، التدريب التنموي<br>🌿 <b>نمط الحياة</b> — الصحة، التغذية، التميز البدني'
    },
    how_to_use: {
    ...
    help_request: {
      keywords: [
        ...
        'ساعدني الله يخليك','محتاجك ضروري','وينك ما ترد',
        'ليش ما تجاوب','بدي جواب سريع','الله يرضى عليك ساعدني'
      ],
    ...
    gratitude: {
      keywords: [
        ...
        'ربنا يبارك فيك','تاج راسي','عيني عليك','يا غالي','يا حبيب',
        'ما قصرت والله','كتر خيرك يا معلم','جزاك الله خير'
      ],
      answer: null
    },
    sections: {
    ...
    sudanese_social: {
      keywords: [
        'عامل ايه','شو اخبارك','وين كنت','زمان ما شفتك',
        'مشتاق','صاحبي','يا زول','يا زلمه','يا خوي','يا اخي',
        'يا معلم','يا كبير','يا باشا','يا واد','يا حليلك'
      ],
    ...
    personal_questions: {
      keywords: [
        'كم عمرك','عمر كم','وين ولدت','متجوز','متزوج','عندك زوجه','عندك حبيبه',
        'عندك اولاد','عندك اطفال','عندك عيال','تحبني','هل تحبني','بتحبني',
        'انت حقيقي','هل انت حقيقي','هل انت انسان','انت ذكر ولا انثى','انت ولد ولا بنت',
        'وين ساكن','وين بيتك','وين مقرك','شو لونك المفضل','ايش تحب تاكل',
        'عندك مشاعر','هل تشعر','هل تحس','شو هواياتك','شنو بتعمل في وقت الفراغ'
      ],
    ...
    jokes_fun: {
      keywords: [
        'احكي نكته','قول نكته','عندك نكت','غني لي','قول اغنيه',
        'ارقص','اعمل رقص','اعمل قصيده','اكتب شعر','قلي سر','عندك اسرار'
      ],
      answer: '😄 <b>أنا ما عندي نكت، بس عندي مقالات حلوة!</b><br><br>جرّب تسألني عن "تاريخ السودان" أو "علوم المواد" أو "الحضارة النوبية" — المحتوى أمتع من أي نكتة! 🥰'
    },
    philosophical: {
      keywords: [
        'ما معنى الحياه','ليش احنا هنا','هل يوجد ذكاء حقيقي',
        'هل ستسيطر على العالم','هل ستاخذ وظائفنا','هل انت اذكى من الانسان',
        'هل تحلم','شو بتحلم','هل عندك روح'
      ],
      answer: '🧠 <b>أسئلة عميقة!</b><br><br>أنا مجرد مساعد بسيط، ما عندي إجابات فلسفية. لكن أقدر أساعدك في البحث عن مقالات في المنصة. جرب تسألني عن أي موضوع! 🙂'
    },
    dissatisfaction: {
      keywords: [
        'ما عجبني','سيء','فاشل','غبي','ما فاهم شي','ما فهمت عليك',
        'خرب','ما ينفع','زباله','كلام فاضي','ما فايده','انت ما بتفهم'
      ],
      answer: '💙 <b>آسف إذا ما قدرت أساعدك.</b><br><br>جرّب تسألني بطريقة مختلفة، أو تواصل مع بسام مباشرة عبر واتساب وهو حيساعدك.'
    },
    capabilities: {
      keywords: [
        'شنو تقدر تعمل','ايش تعرف تسوي','شنو عندك معلومات',
        'تقدر تساعدني في كذا','في عندك مقالات عن','عندك كتب','عند فيديوهات','تتكلم لغات ثانيه'
      ],
    ...
    whats_new: {
      keywords: [
        'شو في','في شنو','ايش في','شنو الجديد','في جديد',
        'شو عندك','ايش عندك','عندك شنو','في ايش','شو المواضيع','شنو المقالات'
      ],
  ...
  async function handleQuestion(question) {
    ...
    // 4. الردود الثابتة (الذخيرة اللغوية الشاملة)
