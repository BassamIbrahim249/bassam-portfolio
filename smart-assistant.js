...
(function() {
  ...
  const knowledgeBase = [// ========== 🆕 قاعدة المعرفة الموسَّعة (أضف الإضافات الجديدة هنا) ==========
{
...
{
  keywords: ['مروي','مملكة مروي','كوش','نبتة','نبتة','بجراوية','اهرامات','أهرامات','نوبي','نوبة','نوبيه','نوبية','حضارة نوبية','فراعنة','فرعون','تاريخ نوبة','لغة نوبية','عمارة نوبية'],
